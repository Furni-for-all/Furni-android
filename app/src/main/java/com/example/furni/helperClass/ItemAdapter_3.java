...
public class ItemAdapter_3 extends RecyclerView.Adapter<ItemAdapter_3.ViewHolder>{
    ...
    public ItemAdapter_3(Context ctx, List<String> titles, List<Integer> images) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ItemAdapter_3.ViewHolder holder, int position) {
